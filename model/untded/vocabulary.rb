module Untded
  ...
  module Vocabulary
    ...
    CLASSES = {
      ...
      "Representation" =>
        "The character representation of a data element: charset, length bounds, and the printed notation.",
      "Bridge" =>
        "A location of a data element on a document scheme of an aligned trade document system (UNLK, SAD, MAR, CIMP, …).",
      "UnlkZone" =>
        "A line and character-position span locating an element on the UN layout key.",
      "Category" =>
    ...
    TERMS = {
      ...
      "Representation" => { group: "classes", iri: "utd:Representation" },
      "Bridge" => { group: "classes", iri: "utd:Bridge" },
      "UnlkZone" => { group: "classes", iri: "utd:UnlkZone" },
      ...
      "representation" => { group: "element-level", iri: "utd:representation", domain: "TradeDataElement",
                            comment: "The character representation as a structured node: printed form, charset, length bounds." },
      "printedForm" => { group: "element-level", iri: "utd:printedForm", domain: "Representation",
                         comment: "The printed representation notation, e.g. an..35." },
      "charset" => { group: "element-level", iri: "utd:charset", domain: "Representation",
                     comment: "The character class of the representation: a, an or n." },
      "minLength" => { group: "element-level", iri: "utd:minLength", domain: "Representation",
                       comment: "Minimum number of characters in a value." },
      "maxLength" => { group: "element-level", iri: "utd:maxLength", domain: "Representation",
      ...
      "bridge" => { group: "element-level", iri: "utd:bridge", domain: "TradeDataElement",
                    comment: "One parsed location on a document scheme, with its zones when the scheme is the UN layout key." },
      "scheme" => { group: "element-level", iri: "utd:scheme", domain: "Bridge",
                    comment: "The document scheme the bridge locates the element on (UNLK, SAD, MAR, CIMP, …)." },
      "detail" => { group: "element-level", iri: "utd:detail", domain: "Bridge",
                    comment: "The bridge detail as printed." },
      "zone" => { group: "element-level", iri: "utd:zone", domain: "Bridge",
                  comment: "A line and character-position span on the UN layout key." },
      "lineFrom" => { group: "element-level", iri: "utd:lineFrom", domain: "UnlkZone",
                      comment: "First line of the span on the UN layout key." },
      "lineTo" => { group: "element-level", iri: "utd:lineTo", domain: "UnlkZone",
                    comment: "Last line of the span on the UN layout key." },
      "posFrom" => { group: "element-level", iri: "utd:posFrom", domain: "UnlkZone",
                     comment: "First character position of the span." },
      "posTo" => { group: "element-level", iri: "utd:posTo", domain: "UnlkZone",
                   comment: "Last character position of the span." },
      "fieldFormat" => { group: "element-level", iri: "utd:fieldFormat", domain: "UnlkZone",
                         comment: "The interchange format token of the field, e.g. an..17." },
